...
目前使用HybridCLR的国内外商业游戏数千款，其中并已经上线（AppStore或GooglePlay）的商业项目远超千款。
我们只统计了中国区畅销榜top 200和免费榜top 500中使用HybridCLR方案的商业项目。

:::tip

以下数据是**2024-02-02**统计的。由于iOS AppStore更新了ipa下载要求，无法继续使用自动化工具分析，我们已经超过一年未更新商业案例数据。
当前App Store畅销榜和免费榜中使用HybridCLR的比例应该大幅高于以下数据。

:::

## 25-35%的头部Unity热更新游戏使用了HybridCLR

我们统计了2024-02-02 App Store畅销榜top200中129款游戏app数据。使用Unity开发的有65款，使用非Unity开发的有64款。
...
类似的，我们统计了2024-02-02 App Store免费榜top500名中除了不在畅销榜中的326款游戏app的数据。其中Unity游戏有140款，非Unity游戏有186款。
