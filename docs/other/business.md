...
旗舰版相对社区版在性能方面有巨幅提升，基本达到原生性能水平，同时完全泛型共享技术让工作流、包体和内存占用得到显著优化，是大型或性能要求严苛的项目的最佳选择。
...
- **已支持增量式GC**
- **深度指令优化技术**，对指令进行深度优化，解释性能整体提升100%-1000%（没看错，10倍以上）甚至更高，对于数值指令整体提升近300%，同时有更优异的加载性能
- 支持对dll代码混淆，天然抗反编译破解。
